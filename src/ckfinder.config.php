...
//    if (!is_dir($_SERVER['DOCUMENT_ROOT'].'/assets/.yii_tmp')) {
//        mkdir($_SERVER['DOCUMENT_ROOT'].'/assets/.yii_tmp', 0777);
//    }
//    session_save_path($_SERVER['DOCUMENT_ROOT'].'/assets/.yii_tmp');
	session_start();
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = dirname(__DIR__) . '/../../../frontend/web' . $baseUrl;
/*
 * ### Advanced Settings
 */
